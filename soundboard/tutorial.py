...
# Which is why the steps about System Settings, pavucontrol and Discord
# have no picture: they are other applications, so the tool cannot drive
# them, and a hand-captured shot of someone else's UI goes stale on their
# next release with nothing here to catch it.
...
_NO_CABLE_SHOT = (
    "It appears above the sound list until a cable is there to pick."
)
...
PAGES = {
    WINDOWS: [
        ...
        ("shot", "cable-windows", _NO_CABLE_SHOT),
    ...
    MACOS: [
        ...
        ("shot", "cable-macos", _NO_CABLE_SHOT),
        ("step", "Point Soundboard at it",
         "Open the Settings tab, or the Settings button on the Soundboard "
         "tab, and set Microphone to your real microphone and Virtual mic "
